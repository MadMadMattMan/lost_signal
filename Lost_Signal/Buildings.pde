...
public static final ArrayList<BuildingType> mineBuilding = new ArrayList<>() {
  {
    add(BuildingType.mine);
  }
};
public static final ArrayList<BuildingType> lumberBuilding = new ArrayList<>() {
  {
    add(BuildingType.lumber);
  }
};
public static final ArrayList<BuildingType> relayBuilding = new ArrayList<>() {
  {
    add(BuildingType.relay);
  }
};
public static final ArrayList<BuildingType> storageBuilding = new ArrayList<>() {
  {
    add(BuildingType.storage);
  }
};
public static final ArrayList<BuildingType> factoryBuilding = new ArrayList<>() {
  {
    add(BuildingType.factory);
  }
};
public static final ArrayList<BuildingType> bankBuilding = new ArrayList<>() {
  {
...
Building newBuilding(PVector pos, BuildingType type) {
  ...
  switch (type) {
  case test:
    return new TestBuilding(pos);
  case mine:
    return new GathererBuilding(pos, type);
  case lumber:
    return new GathererBuilding(pos, type);
  case relay:
    return new RelayBuilding(pos);
  case storage:
    return new StorageBuilding(pos);
  case factory:
    return new FactoryBuilding(pos);
  case bank:
    return new BankBuilding(pos);
    // case export:
  default:
    return null;
  }
...
public PVector cornerOffset(PVector position, PVector xySize, int corner) {
  ...
  case 3:
    ...
    break;
  default:
    println("invalid corner called for cornerOffset");
  }
...
public class BankBuilding implements Building {
  ...
  void render() {
    image(bankIcon, renderX, renderY, dSize, dSize);
  } //draws the building
